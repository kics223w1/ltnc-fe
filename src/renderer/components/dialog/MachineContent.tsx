...
const DialogDeleteMachineContent = ({
  machine,
  onSave,
  onClose,
  ...
  return (
    <>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Xóa các máy đã chọn</DialogTitle>
          <DialogDescription>
            Bạn có muốn xóa các máy đã chọn không?
          </DialogDescription>
        </DialogHeader>
...
export default DialogDeleteMachineContent;
